...
parser.add_argument("--midtrain", default=None, type=str, help="midtrain (cosine LR) starting from this pretrained checkpoint")
parser.add_argument("--finetune", default=None, type=str, help="finetune (linear LR) starting from this pretrained checkpoint")
