...
#SBATCH --job-name=houjun-forking-final_pretrain_1_9b_fork
#SBATCH --nodes=1
...
#SBATCH --output=./logs/final_pretrain_1_9b_fork.log
...
srun --export=ALL bash -lc '
  ...
  ./experiments/scripts/develop "
    ...
    uv run --no-group tpu --group cuda python \
      main.py \
      final_pretrain_1_9b_fork \
      --warm_start /sphinx/u/houjun/checkpoints/fork/final_pretrain_1_9b_fork/recovery \
