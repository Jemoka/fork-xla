...
#SBATCH --job-name=houjun-forking-eval_pretrain_1_9B_fork
#SBATCH --nodes=1
...
#SBATCH --output=./logs/eval_pretrain_1_9B_fork.log
...
CHECKPOINT_PATH="${CHECKPOINT_PATH:-/sphinx/u/houjun/checkpoints/fork/jax/pretrain/final_pretrain_1_9b_fork/best}"

# Optional: specify evals (space-separated), or leave empty for all
EVALS="${EVALS:-}"

# Output file for results
OUTPUT_FILE="${OUTPUT_FILE:-/juice2/scr2/houjun/fork-xla/output/eval_pretrain_1_9B_fork_results.json}"
