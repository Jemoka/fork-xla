...
#SBATCH --job-name=houjun-forking-final_pretrain_1_9b_fork_short
#SBATCH --nodes=1
...
#SBATCH --output=./logs/final_pretrain_1_9b_fork_short.log
...
srun --export=ALL bash -lc '
  ...
  ./experiments/scripts/develop "
    ...
    uv run --no-group tpu --group cuda python \
      main.py \
      final_pretrain_1_9b_fork_short \
      --warm_start /sphinx/u/houjun/checkpoints/fork/final_pretrain_1_9b_fork_short/recovery \
      --data_file /home/houjun/data/recipes/pretrain.toml \
      --data_file /juice2/scr2/houjun/fork-xla/experiments/data/owt.toml \
      --plan regular regular fork regular regular fork regular regular fork regular regular regular regular regular regular regular regular regular regular regular regular regular regular regular regular regular regular regular regular regular regular regular regular regular regular regular \
